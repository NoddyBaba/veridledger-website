...
export async function GET(request: Request) {
  try {
    ...
    // 1. Fetch live odds from The-Odds-API (Upcoming games across major US sports)
    const oddsUrl = `https://api.the-odds-api.com/v4/sports/upcoming/odds/?regions=us&markets=h2h,spreads,totals&oddsFormat=american&apiKey=${ODDS_API_KEY}`;
